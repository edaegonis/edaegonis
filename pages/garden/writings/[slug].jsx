...
export default () => (
  <section>
    <Container>
      <TextDocument>
        <Text size="xlarge">computational design</Text>
        <Text size="large">the trigger</Text>
        <Text>
          As a child, I used to play a lot of video games. Eventually, it
          triggered my curiosity to understand how those games were built. So I
          started to learn programming languages, by experimenting with them
        ...
        <Text size="large">the initiate 🚀</Text>
        <Text>
        ...
        <Text size="large">the function 📜🗝️🗡️</Text>
        <Text>
          ...
          projects. For me, experiencing and putting things into practice allows
          me to really grasp into the knowledge.
          <br />
          <br />
          Fortunately, the open-source process turns the technology scenario
          into a symbiotic environment, allowing me and others to share and grow
          exponentially. I flow with this process by increasingly{" "}
          <a>participating</a> in these communities
        </Text>

        <Text size="large">the afterwards 🧙‍♂️</Text>
        <Text>
          Since the cycle of learning, sharing and growing is endless, nowadays
          I use these experiences to move myself
          <br />
          <br />
          Creating awesome technology is something that brings me fulfilment.
          The adept arrives by joining action, devotion and knowledge with these
          experiences, and then keeping the balance with all the other aspects
          of life.
          <br />
          <br />
